      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-12 reveal-up">
          ...
          <h2 className="text-section-heading font-extrabold text-foreground">
            Why Choose <span className="text-primary">Star Computer?</span>
          </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-5">
          {whyChooseUs.map((item, i) => (
            ...
            >
              <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-primary/10 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-all duration-300">

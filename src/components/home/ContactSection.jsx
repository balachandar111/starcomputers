...
import { WHATSAPP_NUMBER, PHONE_NUMBER, PHONE_NUMBER_2, EMAIL, ADDRESS, BUSINESS_HOURS, GOOGLE_MAPS_LINK, LOCATIONS, serviceCategories } from '@/data/starComputerData';
